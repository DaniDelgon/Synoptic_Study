...
coord=np.loadtxt('/Users/fredm/Desktop/tfg/6_comps/KMEANS/regiones.txt',dtype=int)
...
ARR[:,2]=agnos[:-1]
#print(ARR[0:2,:])
np.savetxt('/Users/fredm/Desktop/tfg/precxreg.txt',ARR,delimiter=' , ',fmt='%.1f')